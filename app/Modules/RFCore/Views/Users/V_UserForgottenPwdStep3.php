...
<article class="card-body col-lg-4 col-md-6 col-10" >
	...
	<form id="formPwdReset" action="<?php echo site_url($action); ?>" method="post">
		...
		<div class="form-group">
			<button type="submit" class="btn btn-default btn-block mb-3">Modifier</button>
			<a type="button" class="btn btn-default btn-block" href="<?php echo base_url();?>">Retour à la page de connexion</a>
